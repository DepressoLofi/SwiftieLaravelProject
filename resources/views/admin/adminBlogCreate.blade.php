...
@section('adminContent')
    <div class="flex justify-center ms-4">
        <form action="{{ route('blogs.adminStore') }}" method="post"
            ...
            <div class="items-center">
                <div class="relative w-full h-96 px-26 z-10">
                    <img id='preview_img' class="w-full h-full " src="{{ URL('images/addImage.png') }}"
            ...
            <div class="mt-4 mb-4">
                ...
                <textarea name="content" class="p-2 w-full min-h-[500px] overflow-hidden focus:outline-none" id="auto-resize-textarea"
                    rows="auto">{{ old('content') }}</textarea>
            </div>


            <button type="submit" name="publish" value="publish"
                class="shadow bg-purple-700 hover:bg-purple-950 focus:shadow-outline p-2.5 focus:outline-none text-white font-bold py-2 px-4 rounded ms-2 mb-4">Upload
                Post</button>
